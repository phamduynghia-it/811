...
const NUMBER_OF_IMAGES = 4; // <--- CHỈ CẦN THAY ĐỔI SỐ NÀY
// Hàm tạo danh sách ảnh: ["images/a1.png", "images/a2.png", ...]
const randomImages = Array.from({ length: NUMBER_OF_IMAGES }, (_, i) => `images/a${i + 1}.jpg`);
// =================================================================
...
function createGift() {
    ...
    const message =
        "chúc chị iu một mùa giáng sinh đặc biệt ạ , mãi xinh , yêu đời như này nhaa 😘😘";
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.addEventListener("click", (e) => {
        if (e.target.closest('.gift-popup') || e.target.closest('.music-toggle') || e.target.closest('.tiktok-logo')) {
            return;
        }
